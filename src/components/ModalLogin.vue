        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <BtnSignInWithGoogle class="mb-4" />

                <template v-if="!tryFacebookLogin">
                  <v-btn
                    color="primary"
                    class="text-capitalize font-weight-bold subheading btn-special-purple mb-4"
                    large
                    block
                    @click="tryFacebookLogin = true"
                  >
                    <span class="icon" />
                ...
                <template v-else>
                  <BtnSignInWithFacebook class="mb-4" />
                </template>
...
export default {
  ...
  components: {
    BtnSignInWithGoogle: () => import('./BtnSignInWithGoogle.vue'),
    BtnSignInWithFacebook: () => import('./BtnSignInWithFacebook.vue')
  },
  ...
  data () {
    return {
      ...
      form: {
        username: 'fabijan.miitrovic@gmail.com',
        password: '123456'
      },
      validationErrors: {},
      remember: true,
